...
-- CreateIndex
CREATE INDEX "MediaAttachment_noteId_idx" ON "MediaAttachment"("noteId");
...
-- AddForeignKey
ALTER TABLE "MediaAttachment" ADD CONSTRAINT "MediaAttachment_noteId_fkey" FOREIGN KEY ("noteId") REFERENCES "Note"("id") ON DELETE CASCADE ON UPDATE CASCADE;
